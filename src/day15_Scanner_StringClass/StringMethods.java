...
public class StringMethods {
	...
	// index num:    01234567
		...
		// charAt(index):
			...
			System.out.println( str2.charAt(2) );
			                                     ...
			                                     //maselan dtring ning kainiga name : donaldJ Trump
			                                     // dap yezip mushu hatning kanqa dana karakter numri barlikinni
			                                     // tapmakqi bolsak (System.out.println( name.length() );
	  // length():                              // kilsak umumi karakter  numuri 14 dap qekirip beridu 
			                                    //
	 ...
	 */
		...
		String name5 ="mihrigultmahmoud";  // bu esimda 16 dana karakter bar 
		System.out.println(name5.length());
					
		String a1 ="Mihrigul";	
		a1.concat("tursun Mahmoud");
		System.out.println(a1);
		
		String b1 = a1.concat("tursun mahmoud");
